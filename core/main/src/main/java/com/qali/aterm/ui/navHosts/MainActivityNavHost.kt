package com.qali.aterm.ui.navHosts
...
import com.qali.aterm.ui.animations.NavigationAnimationTransitions
import com.qali.aterm.ui.routes.MainActivityRoutes
import com.qali.aterm.ui.screens.customization.Customization
import com.qali.aterm.ui.screens.downloader.Downloader
import com.qali.aterm.ui.screens.settings.Settings
import com.qali.aterm.ui.screens.setup.RootfsSetupScreen
    ...
    NavHost(
        ...
        composable(MainActivityRoutes.MainScreen.route) {
            if (Rootfs.isDownloaded.value){
                ...
                // Show setup screen if no rootfs is installed
                RootfsSetupScreen(
                    mainActivity = mainActivity,
                    navController = navController,
                    onSetupComplete = {
                        // Setup complete, will automatically navigate to terminal
                        // Rootfs.isDownloaded will be updated and trigger recomposition
                    }
                )
            }
        }
